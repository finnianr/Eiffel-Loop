...
The following modules dating back to 2007-2008 are no longer maintained but are included for posterity.
### Eiffel to Matlab Interface
Developed with [Matlab](http://uk.mathworks.com/products/matlab/) Version 6.5, VC++ 8.0 Express Edition, Windows XP SP2.
### Eiffel to [Praat](http://www.fon.hum.uva.nl/praat/) Script Interface
[Praat](http://www.fon.hum.uva.nl/praat/) is a free tool for doing acoustic and phonetic analysis. It has it's own scripting language, [Praat](http://www.fon.hum.uva.nl/praat/) Script.

The `el_toolkit` utility has an option for converting the [Praat](http://www.fon.hum.uva.nl/praat/) 4.4 source code to compile with MSC. [Praat](http://www.fon.hum.uva.nl/praat/) is designed to compile with mingw compiler, but at the time this was developed EiffelStudio didn't support mingw.

Developed with VC++ 8.0 Express Edition, Windows XP SP2, [Praat](http://www.fon.hum.uva.nl/praat/) source code version 4.4.30.
The conversion tool will not work with later versions of [Praat](http://www.fon.hum.uva.nl/praat/).
Laabhair Module

**Laabhair** is a digital signal processing framework that allows you process speech with a [Praat](http://www.fon.hum.uva.nl/praat/) script in real time and create visual representations of the the data in Flash. Requires the Eiffel [Praat](http://www.fon.hum.uva.nl/praat/) Script module.
