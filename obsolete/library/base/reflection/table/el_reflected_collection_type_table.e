note
	...
	date: "2022-12-09 16:22:20 GMT (Friday 9th December 2022)"
	revision: "10"
	...
	make
		...
		do
			...
			across type_list as type loop
				if attached {EL_COLLECTION_TYPE [ANY]} Makeable_factory.new_item_from_type (type.item) as collection then
