...
feature {JAVA_ORB} -- Element change

	open (libjvm_path: EL_FILE_PATH; a_class_path: STRING)
			--
		local
...
feature -- Element change
	...
	load_jvm (libjvm_path: EL_FILE_PATH; jvm_options: ARRAY [JAVA_VM_OPTION])
