note
	description: "[
		Copy of `Key_strings' from class [$source EV_KEY_CONSTANTS] for use in sub-application:
		[$source CHECK_LOCALE_STRINGS_APP]. These localized names are referenced in class [$source EL_MENU]
	]"
	...
	date: "2021-03-02 17:20:25 GMT (Tuesday 2nd March 2021)"
	revision: "5"
