note
	...
	date: "2022-12-08 12:21:44 GMT (Thursday 8th December 2022)"
	revision: "3"
...
feature {NONE} -- Implementation
	...
	factory_for_type (type_id: INTEGER): detachable EL_FACTORY [ANY]
		...
		do
			across Factory_list as list until found loop
				if list.item.is_valid_type (type_id) then
					Result := list.item.new_item_factory (type_id)
					found := True
				end
			end
		end
