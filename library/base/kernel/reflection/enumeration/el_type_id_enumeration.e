note
	...
	date: "2025-04-05 10:21:46 GMT (Saturday 5th April 2025)"
	revision: "17"
...
feature {NONE} -- Initialization
	...
	make
		local
			i, count, type_id: INTEGER; type_name: STRING
		do
			if attached property (Current) as this then
				...
				from i := 1 until i > count loop
					if this.field_type (i) = Integer_32_type then
						...
						type_id := dynamic_type_from_string_8 (type_name)
						if type_id >= 0 then
