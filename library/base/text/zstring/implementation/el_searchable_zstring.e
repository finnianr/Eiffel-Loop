note
	...
	date: "2020-04-05 15:32:50 GMT (Sunday 5th April 2020)"
	revision: "1"
...
feature {NONE} -- Implementation
	...
	internal_last_index_of (c: CHARACTER_8; start_index_from_end: INTEGER): INTEGER
		deferred
		end

	internal_index_of (c: CHARACTER_8; start_index: INTEGER): INTEGER
		deferred
		end
