note
	...
	date: "2022-02-11 19:23:48 GMT (Friday 11th February 2022)"
	revision: "6"
	...
	latin_character (uc: CHARACTER_32): CHARACTER
		...
		do
			inspect uc
				...
				when 'Ľ'..'ľ' then
					Result := latin_set_10 [uc.code - 317]
				when 'Ŕ'..'ŕ' then
					Result := latin_set_11 [uc.code - 340]
				when 'Ĺ'..'ĺ' then
					Result := latin_set_12 [uc.code - 313]
				when 'Ň'..'ň' then
					Result := latin_set_13 [uc.code - 327]
				when 'Ő'..'ő' then
