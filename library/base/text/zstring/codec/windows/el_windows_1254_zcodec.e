...
feature -- Character query
	...
	in_latin_1_disjoint_set (c: CHARACTER): BOOLEAN
		...
		do
			inspect c
				when Substitute, '%/0128/', '%/0130/'..'%/0140/', '%/0145/'..'%/0156/', '%/0159/', 'Ð', 'Ý', 'ð', 'ý' then
					Result := True
			else
			end
		end
