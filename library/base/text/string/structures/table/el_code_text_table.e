note
	description: "[
		Table of text looked up by an ${INTEGER_64} from an indented table manifest.
		Codes that have already been found are cached in a hash table of type
	...
	date: "2024-08-21 14:28:04 GMT (Wednesday 21st August 2024)"
	revision: "1"
...
feature -- Status query
	...
	has_key (code: INTEGER_64): BOOLEAN
		...
		do
			...
			elseif manifest.is_string_8 and then attached {READABLE_STRING_8} manifest as str_8 then
