note
	description: "Convert ${READABLE_STRING_GENERAL} to type ${IMMUTABLE_STRING_32}"
	...
	date: "2025-04-03 14:23:11 GMT (Thursday 3rd April 2025)"
	revision: "9"
...
feature -- Conversion
	...
	substring_as_type (str: READABLE_STRING_GENERAL; start_index, end_index: INTEGER): IMMUTABLE_STRING_32
		...
		do
			...
			super_readable_general (str).append_substring_to_string_32 (str_32, start_index, end_index)
