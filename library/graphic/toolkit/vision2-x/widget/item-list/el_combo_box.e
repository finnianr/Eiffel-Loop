note
	...
	date: "2025-05-23 7:31:32 GMT (Friday 23rd May 2025)"
	revision: "13"
...
feature -- Basic operations
	...
	adjust_width
		do
			set_minimum_width (Text_.widest_width (strings, font) + font.string_width ("M") * 3)
...
feature -- Element change
	...
	set_strings (a_string_array: INDEXABLE [READABLE_STRING_GENERAL, INTEGER])
		...
		do
			...
			set_minimum_width (Text_.widest_width (strings, font) + font.string_width (triple_o))
		end
