note
	...
	notes: "[
		**Compiler Bug 16.05**
		...
		causes the compiler to crash while generating the C code for this class. Using casting as a
		workaround.
	]"
	...
	date: "2021-02-25 14:17:50 GMT (Thursday 25th February 2021)"
	revision: "3"

class
	EL_SCROLLABLE_DATEABLE_SEARCHABLE_RESULTS [G -> {EL_HYPERLINKABLE, EL_WORD_SEARCHABLE}]
