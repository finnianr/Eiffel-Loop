note
	...
	date: "2020-07-28 17:48:20 GMT (Tuesday 28th July 2020)"
	revision: "3"
...
feature {EL_PANGO_CAIRO_CONTEXT_IMP} -- Implementation

	new_gdi_bitmap: WEL_GDIP_BITMAP
		-- copy of surface data
		local
			source_rect: WEL_GDIP_RECT; l_data: WEL_GDIP_BITMAP_DATA
			l_surface: EL_CAIRO_SURFACE_I; l_context: EL_PANGO_CAIRO_CONTEXT_I
		do
			...
			create {EL_CAIRO_SURFACE_IMP} l_surface.make_with_argb_32_data (l_data.scan_0, width, height)
			create {EL_PANGO_CAIRO_CONTEXT_IMP} l_context.make (l_surface)
