...
inherit
	EL_OWNED_C_OBJECT
		rename
			self_ptr as context
		export
			{EL_DRAWABLE_PIXEL_BUFFER_I, EL_SVG_IMAGE, EL_DRAWABLE_CAIRO_CONTEXT_I} context
		end
...
feature -- Status change
	...
	set_source_pattern (pattern: EL_CAIRO_PATTERN)
		do
...
feature -- Drawing operations
	...
	draw_scaled_surface (dimension: NATURAL_8; x, y, size: DOUBLE; a_surface: EL_CAIRO_SURFACE_I)
		...
		-- /-/-/cairo_pattern_create_for_surface/cpp-cairo_pattern_create_for_surface-function-examples.html
		local
			pattern: EL_CAIRO_PATTERN; proportion: DOUBLE; matrix: EL_CAIRO_MATRIX
		do
			if dimension = By_width then
	...
	draw_surface (x, y: DOUBLE; source: EL_CAIRO_SURFACE_I)
		do
...
feature {EL_DRAWABLE_PIXEL_BUFFER_I, EL_DRAWABLE_CAIRO_CONTEXT_I} -- Internal attributes
