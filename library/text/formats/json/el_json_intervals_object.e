note
	...
	date: "2022-06-21 13:46:56 GMT (Tuesday 21st June 2022)"
	revision: "6"
...
feature {NONE} -- Initialization
	...
	make (utf_8: STRING)
		...
		local
			field_list: EL_JSON_NAME_VALUE_LIST; name: STRING; field_index, text_count: INTEGER
		do
...
feature {EL_JSON_INTERVALS_OBJECT} -- Factory
...
feature {NONE} -- Constants
	...
	Enumeration_by_type: EL_FUNCTION_RESULT_TABLE [
		EL_JSON_INTERVALS_OBJECT [EL_ENUMERATION [NATURAL_16]], EL_ENUMERATION [NATURAL_16]
	]
		once
			create Result.make (11, agent {EL_JSON_INTERVALS_OBJECT [EL_ENUMERATION [NATURAL_16]]}.new_enumeration)
		end
