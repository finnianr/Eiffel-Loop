note
	...
	notes: "See class ${EVC_SHARED_TEMPLATES} for documentation"
...
feature {NONE} -- Factory
	...
	new_getter_functions: like getter_functions
		...
		do
			...
			Result [Var.current_object] := agent: EVC_CONTEXT do Result := Current end
		end
...
feature {EVC_DIRECTIVE} -- Internal attributes
