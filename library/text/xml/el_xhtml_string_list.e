...
inherit
	EL_LINKED_STRING_LIST [EL_ASTRING]
...
feature {NONE} -- Initialization
	...
	remove_trailing_line_breaks
		...
		local
			last_line, two_lines, end_tag, inbetween_chars: EL_ASTRING
			tag_found: BOOLEAN
...
feature {NONE} -- State handlers
	...
	find_pre_tag_end (line: EL_ASTRING)
			--
		do
...
feature {NONE} -- Implementation
	...
	space_entity: EL_ASTRING

	text_group_end_tags: ARRAYED_LIST [EL_ASTRING]

	substitutions: ARRAYED_LIST [TUPLE [original, new: EL_ASTRING]]

feature {NONE} -- Constants

	Non_breaking_space: EL_ASTRING
		once
			Result := "&nbsp;"
		end
