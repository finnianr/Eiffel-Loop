note
	description: "HTTP status enumeration based on ${EL_ENUMERATION_NATURAL_16}"
	notes: "[
		This implementation is less memory efficient than the ${EL_ENUMERATION_INTEGER_16} ancestor
		used for ${EL_HTTP_STATUS_ENUM}
	]"
	...
	date: "2025-04-25 8:33:47 GMT (Friday 25th April 2025)"
	revision: "3"
