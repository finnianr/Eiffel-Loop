...
feature {NONE} -- State line procedures
	...
	append_playlist_lines (line: ASTRING; a_is_static_playlist: BOOLEAN)
			--
		local
			l_line: ASTRING
		do
...
feature {RBOX_DATABASE} -- Implementation
	...
	non_static_playlist_lines: LINKED_LIST [ASTRING]
